...
print(f"R${saque} serão sacados em {nota_de_100} notas de 100, {nota_de_50} de 50, {nota_de_20} de 20, {nota_de_10} de 10, {nota_de_5} de 5, {nota_de_2} de 2, {moeda_de_1} moedas de 1 real")
